    ...
    <div className="h-full overflow-y-auto bg-white p-6 space-y-6">
      ...
      <div className="bg-gray-50 p-4 rounded-lg space-y-4">
        ...
        <input
          ...
          onChange={(e) =>
            updateCertificateData('recipientName', e.target.value)
          }
        ...
        <input
          ...
          onChange={(e) =>
            updateCertificateData('designation', e.target.value)
          }
          className="w-full px-3 py-2 border rounded-lg bg-white text-gray-900 border-gray-300 focus:ring-2 focus:ring-blue-500"
        />
      </div>
      ...
      <div className="bg-gray-50 p-4 rounded-lg space-y-4">
        ...
        <textarea
          ...
          onChange={(e) =>
            updateCertificateData('appreciationFor', e.target.value)
          }
          className="w-full px-3 py-2 border rounded-lg bg-white text-gray-900 border-gray-300 focus:ring-2 focus:ring-blue-500"
        />
      </div>
      ...
      <div className="bg-gray-50 p-4 rounded-lg space-y-4">
        ...
        <input
          ...
          onChange={(e) =>
            updateCertificateData('joiningDate', e.target.value)
          }
          className="w-full px-3 py-2 border rounded-lg bg-white text-gray-900 border-gray-300 focus:ring-2 focus:ring-blue-500"
        />
      </div>
      ...
      <div className="bg-gray-50 p-4 rounded-lg space-y-4">
        ...
        <input
          ...
          onChange={(e) =>
            updateCertificateData('issueDate', e.target.value)
          }
          className="w-full px-3 py-2 border rounded-lg bg-white text-gray-900 border-gray-300 focus:ring-2 focus:ring-blue-500"
        />
      </div>
